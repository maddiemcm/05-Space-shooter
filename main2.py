...
class Window(arcade.Window):
    ...
    def intro(self):
        arcade.draw_text(f"Welcome to Aliens vs. Donuts!", 400, 700, arcade.color.WHITE, 70)
        arcade.draw_text(f"The goal of the game is that ", 400, 630, arcade.color.WHITE, 70)
    ...
    def level_3(self):
        ...
        for sprinkle in self.sprinkle_list:
            x = self.donut.center_x
            y = self.donut.center_y - 15
            sprinkle = Sprinkles((x,y),(0,-10),BULLET_DAMAGE)
            
            self.sprinkle_list.append(sprinkle)
    ...
    def setup(self):
        ...
        self.sprinkle_list = arcade.SpriteList()
